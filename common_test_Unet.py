...
from utilities import ComputMetric, softmax_helper, get_patch_size
from typing import Union, Tuple, List
from augmentImagerng import AugmenterAffineParams
from augmentSamplerng import augment_sample
from augmentImagerng import augment_imgs_of_case
from numpy.linalg import inv
from sampling_multiprocess import get_augment_par

def nntestATLAS(model, saveresults, name, trainval = False, ImgsegmentSize = [128, 128, 128], deepsupervision = False, DatafileValFold=None, tta=False, ttalist = [0], ttalistprob=[1], NumsClass = 2):
    batch_size = 1
    NumsInputChannel = 1
    if trainval == False:
...
def nntestCardiac(model, saveresults, name, trainval = False, ImgsegmentSize = [128, 128, 128], deepsupervision = False, DatafileValFold=None, tta=False, ttalist = [0], ttalistprob=[1], NumsClass = 2):
    batch_size = 1
    NumsInputChannel = 1
    if trainval == False:
        DatafileFold = DatafileValFold
